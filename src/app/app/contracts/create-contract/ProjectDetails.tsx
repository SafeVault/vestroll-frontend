...
export default function ProjectDetails({
  ...
  const ProgressBar = () => (
    <div className="mb-8">
      ...
      <Stepper className="!flex-1 !w-13" totalSteps={6} currentStep={2} />
    </div>
  );
  ...
  return (
    <div className=" bg-white w-full max-w-4xl mx-2 sm:mx-4 mt-2 sm:mt-4 rounded-lg">
